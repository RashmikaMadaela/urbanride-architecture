...
12. Luxen, D. and Vetter, C. *Open Source Routing Machine (OSRM)*.
    Available at: https://project-osrm.org and https://github.com/Project-OSRM/osrm-backend —
    source for the `table` (distance-matrix) endpoint used in §5.8 to compute many-to-one ETAs in
    a single call.
